...
namespace Korbo {
    namespace KUI {
        KorboWindow::KorboWindow() {
            ...
            m_menu_bar_file_quit_item.set_label(
                    Glib::ustring(i18n_json[i18n]["korbo"]["window"]["menu"]["file"]["quit"].get<std::string>()));
            ...
            m_menu_bar_tools_item.set_label(
                    Glib::ustring(i18n_json[i18n]["korbo"]["window"]["menu"]["tools"]["name"].get<std::string>()));
            m_menu_bar_tools_item.set_submenu(m_menu_bar_tools_menu);
            m_menu_bar_tools_menu.append(m_menu_bar_tools_preferences_item);
            m_menu_bar_tools_preferences_item.set_label(
                    Glib::ustring(i18n_json[i18n]["korbo"]["window"]["menu"]["tools"]["preferences"].get<std::string>()));
            m_menu_bar_tools_preferences_item.signal_activate().connect(
                    sigc::mem_fun(*this, &on_menu_bar_tools_preferences_click));
            ...
            m_menu_bar_help_check_for_updates_item.set_label(
                    Glib::ustring(i18n_json[i18n]["korbo"]["window"]["menu"]["help"]["check-for-updates"].get<std::string>()));
            ...
            m_menu_bar_help_about_item.set_label(
                    Glib::ustring(i18n_json[i18n]["korbo"]["window"]["menu"]["help"]["about"].get<std::string>()));
            ...
            m_profile_options_button.set_label(
                    Glib::ustring(i18n_json[i18n]["korbo"]["window"]["buttons"]["options"].get<std::string>()));
            ...
            m_profile_restore_button.set_label(
                    Glib::ustring(i18n_json[i18n]["korbo"]["window"]["buttons"]["restore"].get<std::string>()));
            ...
            m_mod_list_tree_view.append_column(
                    Glib::ustring(i18n_json[i18n]["korbo"]["window"]["table"]["mods"]["enabled"].get<std::string>()),
                    m_mods_model_columns.m_enabled_column);
            m_mod_list_tree_view.append_column(
                    Glib::ustring(i18n_json[i18n]["korbo"]["window"]["table"]["mods"]["name"].get<std::string>()),
                    m_mods_model_columns.m_name_column);
            m_mod_list_tree_view.append_column(
                    Glib::ustring(i18n_json[i18n]["korbo"]["window"]["table"]["mods"]["version"].get<std::string>()),
                    m_mods_model_columns.m_version_column);
            ...
            m_archives_tab_label.set_label(
                    Glib::ustring(i18n_json[i18n]["korbo"]["window"]["notebooks"]["mods"]["labels"]["archives"].get<std::string>()));
            ...
            m_archives_tab_tree_view.append_column(
                    Glib::ustring(i18n_json[i18n]["korbo"]["window"]["table"]["archives"]["name"].get<std::string>()),
                    m_archives_model_columns.m_name_column);
            m_archives_tab_tree_view.set_model(m_archives_tree_store);

            m_notebook.append_page(m_downloads_tab_box, m_downloads_tab_label);
            m_downloads_tab_label.set_label(
                    Glib::ustring(i18n_json[i18n]["korbo"]["window"]["notebooks"]["mods"]["labels"]["downloads"].get<std::string>()));
